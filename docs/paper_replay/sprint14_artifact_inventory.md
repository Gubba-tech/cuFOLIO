...
The B40 metadata records the node, GPU, CUDA report, cuOpt version, status, and
runtime in `artifacts/paper_replay/gpu_logs/monthly-panel-b40-46129.metadata`.
H200 job 46128 remained pending due to priority and was not used. See
