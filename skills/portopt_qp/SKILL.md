...
- Treat long-short budgets, turnover, benchmark l1 exposure, max-Sharpe QP, and end-to-end IPCA/PCA/AP-Trees factor workflows as not production-ready until their dedicated validation gates exist.
