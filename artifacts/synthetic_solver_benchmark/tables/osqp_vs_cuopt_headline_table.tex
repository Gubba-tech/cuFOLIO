\begin{table}
\caption{Headline synthetic LP/QP comparison between CPU OSQP and direct NVIDIA cuOpt. Timings are medians over common correctness-passing instances.}
\label{tab:osqp-vs-cuopt-headline-table}
\begin{tabular}{lrlllllllrrrll}
\toprule
...
\bottomrule
\end{tabular}
\par\footnotesize Speedup greater than one means cuOpt is faster.
\end{table}
